...
| 109 | Subscription Creation |
    - [x] API: Create subscription with valid plan (TC-34)
    - [x] API: Fail creation without plan_type (TC-35)
    - [x] UI: Verify subscription flow triggers Razorpay (Manual Verify) |
| 109a | Subscription Dates Fix | Added `renewal_date` synced from Razorpay (v4 migration) |
